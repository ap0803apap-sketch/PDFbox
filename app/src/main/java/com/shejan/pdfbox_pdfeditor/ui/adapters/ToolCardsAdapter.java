...
import com.ap.pdf.box.databinding.ItemToolCardBinding;
...
public class ToolCardsAdapter extends RecyclerView.Adapter<ToolCardsAdapter.ToolViewHolder> {
    ...
    class ToolViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Tool tool) {
            ...
            binding.toolIcon.setImageResource(tool.getIconResId());
            
            // Disable tint for colorful extraction icons
            if ("pdf_to_image".equals(tool.getId()) || "text_extraction".equals(tool.getId())) {
                binding.toolIcon.setImageTintList(null);
            } else {
                binding.toolIcon.setImageTintList(android.content.res.ColorStateList.valueOf(
